...
if ($Release) {
    Write-Step "Creating GitHub Release v1.1.0"
    $tag  = "v1.1.0"
    $notes = @"
## สิ่งที่เพิ่มใหม่ใน v1.1.0

### ระบบสิทธิ์การเข้าใช้งาน
- **Login (task 164)**: บัญชีที่ไม่มีสิทธิ์จะถูกปฏิเสธพร้อม popup แจ้งติดต่อ Admin
- **ตั้งค่าการเชื่อมต่อ (task 77)**: ปุ่มตั้งค่าต้องยืนยันตัวตนก่อนเข้าใช้งาน
